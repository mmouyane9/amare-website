-- ============================================================================
-- AMARE National Vision Page Seed Data
-- Inserts all sections into page_sections for slug = '/Who%20are%20we/national-vision.html'
-- ============================================================================
...
BEGIN
  ...
  VALUES (
    ...
    NULL,
    'الرؤية الوطنية',
    'القسم الرئيسي لصفحة الرؤية الوطنية',
    $CONTENT${
  ...
  -- ==========================================================================
  -- 4. NATIONAL PRIORITIES (TIMELINE)
  -- ==========================================================================
  INSERT INTO page_sections (id, page_id, section_type, section_key, title, description, content, settings, styles, visible, sort_order)
  VALUES (
    gen_random_uuid(),
