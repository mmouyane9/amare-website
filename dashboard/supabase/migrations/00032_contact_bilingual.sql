-- ============================================================================
-- Contact Page — Bilingual Conversion (_ar/_fr)
--
-- Converts all 6 sections of the /contact.html page.
-- Idempotent. Arabic sourced from 00022_contact_full_seed.sql.
-- ============================================================================
...
BEGIN
  ...
  FROM pages
  WHERE slug = '/contact.html' AND status = 'published'
  LIMIT 1;

  IF v_page_id IS NULL THEN
    RAISE NOTICE 'Page /contact.html not found — nothing to migrate.';
    RETURN;
  END IF;
  ...
  SET content = '{
    ...
    "description_ar": "إذا كانت لديكم أي استفسارات أو اقتراحات أو ترغبون في الانضمام إلى الجمعية، لا تترددوا في التواصل معنا.",
    "description_fr": "Si vous avez des questions, des suggestions ou souhaitez rejoindre l''association, n''hésitez pas à nous contacter.",
    "backgroundImage": "",
    "buttons": [
  ...
  SET content = '{
    ...
    "description_fr": "Choisissez le moyen le plus adapté pour contacter l''équipe de l''association et nous vous répondrons dans les plus brefs délais.",
    "items": [
  ...
  -- ==========================================================================
  -- 3. CONTACT FORM + INFO CARD (sort_order 3)
  -- ==========================================================================
  UPDATE page_sections
  SET content = '{
    ...
    "description_fr": "Remplissez le formulaire suivant et notre équipe vous contactera dans les plus brefs délais.",
    "infoTitle_ar": "معلومات التواصل",
    "infoTitle_fr": "Informations de contact",
    "infoDescription_ar": "فريقنا جاهز للرد على استفساراتكم من الإثنين إلى الجمعة. لا تترددوا في التواصل معنا عبر أي وسيلة تناسبكم.",
    "infoDescription_fr": "Notre équipe est prête à répondre à vos questions du lundi au vendredi. N''hésitez pas à nous contacter par le moyen qui vous convient.",
    ...
    "formDescription_fr": "Tous les champs sont obligatoires. Vous recevrez une réponse dans les plus brefs délais.",
    "fields": [
  ...
  SET content = '{
    ...
    "description_fr": "Nous avons rassemblé pour vous les réponses aux questions les plus fréquentes sur l''association et les moyens de contact.",
    "items": [
      {"question_ar":"كيف يمكنني الانضمام للجمعية؟","question_fr":"Comment puis-je adhérer à l''association ?","answer_ar":"يمكنكم الانضمام إلى الجمعية عبر ملء استمارة الانخراط المتوفرة على صفحة \"انخرط معنا\"، أو بزيارة مقر الجمعية مباشرة، أو بمراسلتنا عبر البريد الإلكتروني. تُدرَس جميع الطلبات خلال أسبوع واحد من التوصل بها.","answer_fr":"Vous pouvez adhérer à l''association en remplissant le formulaire d''adhésion disponible sur la page \"Rejoignez-nous\", en visitant le siège de l''association, ou en nous contactant par e-mail. Toutes les demandes sont examinées dans un délai d''une semaine."},
      {"question_ar":"كيف أتواصل مع الإدارة؟","question_fr":"Comment contacter l''administration ?","answer_ar":"يمكنكم التواصل مع الإدارة عبر الهاتف +212 684 869 996 من الإثنين إلى الجمعة بين 09:00 و18:00، أو عبر البريد الإلكتروني association.amare.agadir@gmail.com، وسنعاود الاتصال بكم في أقرب وقت ممكن.","answer_fr":"Vous pouvez contacter l''administration par téléphone au +212 684 869 996 du lundi au vendredi entre 09:00 et 18:00, ou par e-mail à association.amare.agadir@gmail.com. Nous vous répondrons dans les plus brefs délais."},
      {"question_ar":"هل يمكنني التطوع؟","question_fr":"Puis-je devenir bénévole ?","answer_ar":"بالتأكيد! نرحب دائمًا بالمتطوعين الجدد. يمكنكم التسجيل عبر نموذج الانخراط أو التواصل معنا مباشرة، وسيتواصل معكم فريق التطوع لتحديد الأنشطة والمجالات التي تناسب مهاراتكم واهتماماتكم.","answer_fr":"Bien sûr ! Nous accueillons toujours de nouveaux bénévoles. Vous pouvez vous inscrire via le formulaire d''adhésion ou nous contacter directement. Notre équipe de bénévolat vous contactera pour déterminer les activités et domaines qui correspondent à vos compétences et intérêts."},
      {"question_ar":"كيف أقدم اقتراحاً؟","question_fr":"Comment soumettre une suggestion ?","answer_ar":"يمكنكم إرسال اقتراحاتكم عبر نموذج التواصل في هذه الصفحة مع تحديد الموضوع \"اقتراح\"، أو عبر البريد الإلكتروني مباشرة. نعتمد على أفكاركم وملاحظاتكم لتطوير برامجنا وتحسين خدماتنا.","answer_fr":"Vous pouvez envoyer vos suggestions via le formulaire de contact sur cette page en sélectionnant le sujet \"Suggestion\", ou directement par e-mail. Nous comptons sur vos idées et remarques pour développer nos programmes et améliorer nos services."}
    ]
  }'::jsonb
  WHERE page_id = v_page_id AND sort_order = 5;

  -- ==========================================================================
  -- 6. CTA BANNER (sort_order 6)
  -- ==========================================================================
  UPDATE page_sections
  SET content = '{
  ...
  RAISE NOTICE '=========================================';
  RAISE NOTICE '  Contact page — all 6 sections migrated to bilingual _ar/_fr.';
