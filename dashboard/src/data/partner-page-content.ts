...
export const ASTROMET: PartnerContent = {
  ...
  formHeading: 'تواصل مع ASTROMET',
  formDescription: 'أرسل لنا استفسارك وسنرد عليك في أقرب وقت.',
  ctaHeading: 'هل أنت مهتم بالعمل مع هذا الشريك؟',
  ctaButtons: [
    { label: 'زيارة الموقع الإلكتروني', url: 'https://www.astromet.ma' },
    { label: 'تواصل مع الشريك', url: '#prForm' },
  ],
}
...
export const ASSOCIATION_DETECTION_CENTRE: PartnerContent = {
  ...
  aboutEyebrow: 'عن AssociationDetectionCentre',
  aboutHeading: 'شريككم الموثوق في مجال التنقيب والاستكشاف',
  aboutImage: '',
  aboutParagraphs: [
  ...
  formHeading: 'تواصل مع AssociationDetectionCentre',
  formDescription: 'أرسل لنا استفسارك وسنرد عليك في أقرب وقت.',
  ctaHeading: 'هل أنت مهتم بالعمل مع هذا الشريك؟',
  ctaButtons: [
    { label: 'زيارة الموقع الإلكتروني', url: 'https://www.detection-centre.ma' },
    { label: 'تواصل مع الشريك', url: '#prForm' },
  ],
}
...
export const ANCPP: PartnerContent = {
  ...
  formHeading: 'تواصل مع ANCPP',
  formDescription: 'أرسل لنا استفسارك وسنرد عليك في أقرب وقت.',
  ctaHeading: 'هل أنت مهتم بالعمل مع هذا الشريك؟',
  ctaButtons: [
    { label: 'زيارة الموقع الإلكتروني', url: 'https://www.ancpp.ma' },
    { label: 'تواصل مع الشريك', url: '#prForm' },
  ],
}
...
export const OMSDS: PartnerContent = {
  ...
  formHeading: 'تواصل مع OMSDS',
  formDescription: 'أرسل لنا استفسارك وسنرد عليك في أقرب وقت.',
  ctaHeading: 'هل أنت مهتم بالعمل مع هذا الشريك؟',
  ctaButtons: [
    { label: 'زيارة الموقع الإلكتروني', url: 'https://www.omsds.org' },
    { label: 'تواصل مع الشريك', url: '#prForm' },
  ],
}
