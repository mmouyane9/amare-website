-- ============================================================================
-- AMARE Homepage Seed Data
-- Inserts all homepage sections into page_sections for slug = '/'
-- ============================================================================
...
BEGIN
  ...
  IF home_id IS NULL THEN
    RAISE EXCEPTION 'Home page not found. Ensure the pages table has a row with slug = ''/''.';
  END IF;

  -- Remove any existing homepage sections before re-inserting (idempotent)
