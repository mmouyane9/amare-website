...
import type { NavigationStats } from '@/types/navigation'

interface Props {
  stats: NavigationStats
}

export default function NavigationStats({ stats }: Props) {
  return (
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-bold">{stats.dropdownCount}</span>
          </div>
        </CardContent>
      </Card>
    </div>
