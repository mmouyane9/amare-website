...
(function (window) {
  ...
  var translations = {
    ar: {
      ...
      'partner.form.fullName': 'الاسم الكامل',
      'partner.form.fullNamePlaceholder': 'الاسم الكامل',
      'partner.form.fullNameRequired': 'هذا الحقل مطلوب',
      'partner.form.email': 'البريد الإلكتروني',
      'partner.form.emailInvalid': 'يرجى إدخال بريد إلكتروني صالح',
      'partner.form.phone': 'الهاتف',
      'partner.form.subject': 'الموضوع',
      'partner.form.subjectDefault': 'اختر الموضوع',
      'partner.form.subjectPartnership': 'طلب شراكة',
      'partner.form.subjectService': 'استفسار عن خدمة',
      'partner.form.subjectCollaboration': 'تعاون مشترك',
      'partner.form.subjectOther': 'أخرى',
      'partner.form.message': 'الرسالة',
      'partner.form.messagePlaceholder': 'اكتب رسالتك هنا...',
      'partner.form.messageRequired': 'هذا الحقل مطلوب',
      'partner.form.submit': 'إرسال',
      'partner.form.successTitle': 'تم الإرسال بنجاح!',
      'partner.form.successMessage': 'شكرًا لتواصلكم معنا. سنقوم بالرد على استفساركم في أقرب وقت ممكن.',

      'sos.form.fullNameLabel': 'الاسم الكامل *',
      'sos.form.fullNamePlaceholder': 'أدخل اسمك الكامل',
      'sos.form.fullNameError': 'الاسم الكامل مطلوب',
      'sos.form.phoneLabel': 'رقم الهاتف *',
      'sos.form.phoneError': 'رقم الهاتف مطلوب',
      'sos.form.emailLabel': 'البريد الإلكتروني <span class="optional">(اختياري)</span>',
      'sos.form.emailError': 'يرجى إدخال بريد إلكتروني صالح',
      'sos.form.cityLabel': 'المدينة *',
      'sos.form.cityDefault': 'اختر المدينة',
      'sos.form.cityAgadir': 'أكادير',
      'sos.form.cityCasablanca': 'الدار البيضاء',
      'sos.form.cityRabat': 'الرباط',
      'sos.form.cityMarrakech': 'مراكش',
      'sos.form.cityFes': 'فاس',
      'sos.form.cityTanger': 'طنجة',
      'sos.form.cityMeknes': 'مكناس',
      'sos.form.cityOujda': 'وجدة',
      'sos.form.cityLaayoune': 'العيون',
      'sos.form.cityDakhla': 'الداخلة',
      'sos.form.cityTetouan': 'تطوان',
      'sos.form.citySafi': 'آسفي',
      'sos.form.cityElJadida': 'الجديدة',
      'sos.form.cityNador': 'الناظور',
      'sos.form.cityKhouribga': 'خريبكة',
      'sos.form.cityBeniMellal': 'بني ملال',
      'sos.form.cityTaroudant': 'تارودانت',
      'sos.form.cityTiznit': 'تيزنيت',
      'sos.form.cityOther': 'أخرى',
      'sos.form.cityError': 'المدينة مطلوبة',
      'sos.form.itemTypeLabel': 'نوع الغرض *',
      'sos.form.itemTypeDefault': 'اختر نوع الغرض',
      'sos.form.itemTypeCards': 'البطاقات الوطنية',
      'sos.form.itemTypePassport': 'جواز السفر',
      'sos.form.itemTypeLicense': 'رخصة السياقة',
      'sos.form.itemTypeWallet': 'محفظة',
      'sos.form.itemTypePhone': 'هاتف',
      'sos.form.itemTypeKeys': 'مفاتيح',
      'sos.form.itemTypeDocuments': 'وثائق',
      'sos.form.itemTypeOther': 'أغراض أخرى',
      'sos.form.itemTypeError': 'نوع الغرض مطلوب',
      'sos.form.lostDateLabel': 'تاريخ الفقدان *',
      'sos.form.lostDateError': 'تاريخ الفقدان مطلوب',
      'sos.form.descriptionLabel': 'وصف الغرض *',
      'sos.form.descriptionPlaceholder': 'صف الغرض المفقود بالتفصيل (اللون، العلامة، المحتويات، أي علامات مميزة...)',
      'sos.form.descriptionError': 'وصف الغرض مطلوب',
      'sos.form.lostLocationLabel': 'مكان الفقدان *',
      'sos.form.lostLocationPlaceholder': 'أين فقدت الغرض؟ (اسم المكان، الحي، الشارع...)',
      'sos.form.lostLocationError': 'مكان الفقدان مطلوب',
      'sos.form.fileUploadLabel': 'رفع صورة <span class="optional">(اختياري)</span>',
      'sos.form.fileUploadText': 'اضغط لرفع صورة للغرض المفقود',
      'sos.form.submit': 'إرسال البلاغ',
      'sos.form.successTitle': 'تم إرسال البلاغ بنجاح!',
      'sos.form.successMessage': 'شكراً لتواصلك معنا. سنقوم بمراجعة بلاغك ونشره عبر قنوات الجمعية في أقرب وقت ممكن. سنتواصل معك فور العثور على غرضك.',

      'mag.newsletter.emailPlaceholder': 'أدخل بريدك الإلكتروني',
      'mag.newsletter.successTitle': 'تم الاشتراك بنجاح!',
      'mag.newsletter.successMessage': 'شكراً لاشتراكك. ستصلك آخر المقالات والتحديثات مباشرة على بريدك الإلكتروني.',

      'store.available': 'متوفر',
      'store.featured': 'مميز',
      'store.viewDetails': 'عرض التفاصيل',
      'store.allProducts': 'جميع المنتجات',
      'store.allCategories': 'جميع الفئات',
      'store.searchPlaceholder': 'ابحث عن منتج...',
      'store.productsCount': 'جميع المنتجات ({count})',
      'store.productNotFound': 'المنتج غير موجود',
      'store.productNotFoundDesc': 'عذراً، لم يتم العثور على المنتج المطلوب.',
      'store.orderWhatsApp': 'السلام عليكم،\n\nأرغب في شراء المنتج التالي:\n\n📦 اسم المنتج: {name}\n\nشكراً لكم.',
      'store.brand': 'العلامة',
      'store.condition': 'الحالة',
      'store.conditionNew': 'جديد',
      'store.conditionUsed': 'مستعمل',
      'store.conditionRefurbished': 'مجدد',
      'store.sku': 'رمز المنتج',
      'store.category': 'الفئة',
      'store.stock': 'المخزون',
      'store.stockInStock': '{count} قطعة',
      'store.stockOut': 'غير متوفر',

      'members.title': 'الأعضاء',
      'members.description': 'إدارة أعضاء الجمعية وبياناتهم.',
      'members.addMember': 'إضافة عضو',
      'members.editMember': 'تعديل العضو',
      'members.searchPlaceholder': 'ابحث برقم العضوية أو الاسم أو البريد الإلكتروني أو رقم الهاتف...',
      'members.filterAll': 'جميع الحالات',
      'members.statusActive': 'نشط',
      'members.statusInactive': 'غير نشط',
      'members.colNumber': 'رقم العضوية',
      'members.colName': 'الاسم الكامل',
      'members.colEmail': 'البريد الإلكتروني',
      'members.colPhone': 'رقم الهاتف',
      'members.colAddress': 'العنوان',
      'members.colStatus': 'الحالة',
      'members.colDate': 'تاريخ الانضمام',
      'members.colActions': 'الإجراءات',
      'members.noMembers': 'لا يوجد أعضاء.',
      'members.tryAdjust': 'جرّب تعديل البحث أو التصفية.',
      'members.addFirst': 'أضف أول عضو للبدء.',
      'members.docsTitle': 'المستندات',
      'members.docsPhoto': 'الصورة',
      'members.docsCINFront': 'البطاقة (أمام)',
      'members.docsCINBack': 'البطاقة (خلف)',
      'members.statsTotal': 'إجمالي الأعضاء',
      'members.statsActive': 'نشط',
      'members.statsInactive': 'غير نشط',
      'members.showing': 'عرض',
      'members.of': 'من',
      'members.editDesc': 'قم بتحديث بيانات العضو أدناه.',
      'members.createDesc': 'املأ البيانات لإضافة عضو جديد.',
      'members.saveSuccess': 'تم تحديث العضو بنجاح',
      'members.createSuccess': 'تم إضافة العضو بنجاح',
      'members.deleteSuccess': 'تم حذف العضو بنجاح',
      'members.saveFailed': 'فشل تحديث العضو',
      'members.createFailed': 'فشل إضافة العضو',
      'members.deleteFailed': 'فشل حذف العضو',
      'members.loadFailed': 'فشل تحميل الأعضاء',
      'members.statusUpdated': 'تم تحديث الحالة',
      'members.statusUpdateFailed': 'فشل تحديث الحالة',

      'organization.name': 'الجمعية المغربية لهواة البحث والاستكشاف',
      'organization.nameShort': 'الجمعية المغربية لهواة<br>البحث والاستكشاف',
      'organization.description': 'الجمعية المغربية لهواة البحث والاستكشاف هي إطار قانوني وطني يجمع الهواة تحت راية واحدة لصون التراث الوطني المغربي.',
      'organization.copyright': '© 2026 الجمعية المغربية لهواة البحث والاستكشاف. جميع الحقوق محفوظة.',

      'join.stepper.personalInfo': 'المعلومات الشخصية',
      'join.stepper.emailVerify': 'التحقق من البريد الإلكتروني',
      'join.stepper.documents': 'الوثائق',
      'join.stepper.review': 'مراجعة المعلومات',
      'join.stepper.done': 'تم التسجيل',
      'join.panel.step1of5': 'الخطوة 1 من 5',
      'join.panel.step2of5': 'الخطوة 2 من 5',
      'join.panel.step3of5': 'الخطوة 3 من 5',
      'join.panel.step4of5': 'الخطوة 4 من 5',
      'join.panel.personalInfo': 'المعلومات الشخصية',
      'join.panel.personalInfoSub': 'البيانات الأساسية للعضو',
      'join.panel.emailVerify': 'التحقق من البريد الإلكتروني',
      'join.panel.emailVerifySub': 'لن يتم مشاركة بريدك الإلكتروني مع أي طرف آخر.',
      'join.panel.documents': 'تحميل الوثائق',
      'join.panel.documentsSub': 'أرفق صورة شخصية وصورة بطاقة التعريف الوطنية',
      'join.panel.review': 'مراجعة المعلومات',
      'join.panel.reviewSub': 'تأكد من صحة المعلومات قبل الإرسال',
      'join.panel.done': 'تم التسجيل',
      'join.panel.doneSub': 'تم تقديم طلب الانخراط بنجاح. سنقوم بمراجعة طلبك والتواصل معك قريبًا.',
      'join.form.firstName': 'الاسم الشخصي *',
      'join.form.lastName': 'الاسم العائلي *',
      'join.form.birthDate': 'تاريخ الازدياد *',
      'join.form.birthPlace': 'مكان الازدياد',
      'join.form.cin': 'رقم البطاقة الوطنية *',
      'join.form.phone': 'رقم الهاتف *',
      'join.form.email': 'البريد الإلكتروني *',
      'join.form.address': 'العنوان',
      'join.form.city': 'المدينة',
      'join.form.profession': 'المهنة (اختياري)',
      'join.form.prev': 'السابق',
      'join.form.next': 'التالي',
      'join.form.submit': 'إرسال الطلب',
      'join.form.declaration': 'أقر وأتعهد بصحة جميع المعلومات الواردة في هذا النموذج، وأتحمل كامل المسؤولية القانونية عن أي معلومات غير صحيحة.',
      'join.upload.dragDrop': 'اسحب الصورة هنا أو انقر للاختيار',
      'join.upload.orClick': 'أو انقر للاختيار',
      'join.upload.maxSize': 'PNG أو JPG — حد أقصى 5MB',
      'join.email.yourEmail': 'بريدك الإلكتروني',
      'join.success.title': 'شكراً لانخراطك!',
      'join.success.memberNumber': 'رقم عضويتك هو:',
      'join.success.keepNumber': 'احتفظ بهذا الرقم للرجوع إليه في المستقبل.',
      'join.success.saved': 'تم حفظ معلوماتكم بنجاح.',
      'join.hero.subtitle': 'املأ الاستمارة التالية للانضمام إلى الجمعية المغربية لهواة البحث والاستكشاف',
      'join.hero.title': 'الانخراط <em>الإلكتروني</em>',
      'join.form.birthPlace': 'مكان الازدياد',
      'join.form.checkbox': 'أصرح بصحة جميع المعلومات المدخلة.',
      'join.otp.instructions': 'تم إرسال رمز تحقق إلى بريدك الإلكتروني، يرجى إدخال الرمز للمتابعة.',
      'join.otp.codeLabel': 'رمز التحقق',
      'join.otp.sendCode': 'إرسال رمز التحقق',
      'join.otp.verify': 'التحقق من الرمز',
    ...
    fr: {
      ...
      'partner.form.fullName': 'Nom complet',
      'partner.form.fullNamePlaceholder': 'Nom complet',
      'partner.form.fullNameRequired': 'Ce champ est requis',
      'partner.form.email': 'Adresse e-mail',
      'partner.form.emailInvalid': 'Veuillez saisir une adresse e-mail valide',
      'partner.form.phone': 'Téléphone',
      'partner.form.subject': 'Sujet',
      'partner.form.subjectDefault': 'Choisissez un sujet',
      'partner.form.subjectPartnership': 'Demande de partenariat',
      'partner.form.subjectService': 'Demande de service',
      'partner.form.subjectCollaboration': 'Collaboration',
      'partner.form.subjectOther': 'Autre',
      'partner.form.message': 'Message',
      'partner.form.messagePlaceholder': 'Écrivez votre message ici...',
      'partner.form.messageRequired': 'Ce champ est requis',
      'partner.form.submit': 'Envoyer',
      'partner.form.successTitle': 'Envoyé avec succès !',
      'partner.form.successMessage': 'Merci de nous avoir contactés. Nous répondrons à votre demande dans les plus brefs délais.',

      'sos.form.fullNameLabel': 'Nom complet *',
      'sos.form.fullNamePlaceholder': 'Entrez votre nom complet',
      'sos.form.fullNameError': 'Nom complet requis',
      'sos.form.phoneLabel': 'Numéro de téléphone *',
      'sos.form.phoneError': 'Numéro de téléphone requis',
      'sos.form.emailLabel': 'Adresse e-mail <span class="optional">(optionnel)</span>',
      'sos.form.emailError': 'Veuillez saisir un e-mail valide',
      'sos.form.cityLabel': 'Ville *',
      'sos.form.cityDefault': 'Sélectionnez la ville',
      'sos.form.cityAgadir': 'Agadir',
      'sos.form.cityCasablanca': 'Casablanca',
      'sos.form.cityRabat': 'Rabat',
      'sos.form.cityMarrakech': 'Marrakech',
      'sos.form.cityFes': 'Fès',
      'sos.form.cityTanger': 'Tanger',
      'sos.form.cityMeknes': 'Meknès',
      'sos.form.cityOujda': 'Oujda',
      'sos.form.cityLaayoune': 'Laâyoune',
      'sos.form.cityDakhla': 'Dakhla',
      'sos.form.cityTetouan': 'Tétouan',
      'sos.form.citySafi': 'Safi',
      'sos.form.cityElJadida': 'El Jadida',
      'sos.form.cityNador': 'Nador',
      'sos.form.cityKhouribga': 'Khouribga',
      'sos.form.cityBeniMellal': 'Béni Mellal',
      'sos.form.cityTaroudant': 'Taroudant',
      'sos.form.cityTiznit': 'Tiznit',
      'sos.form.cityOther': 'Autre',
      'sos.form.cityError': 'Ville requise',
      'sos.form.itemTypeLabel': 'Type d\'objet *',
      'sos.form.itemTypeDefault': 'Sélectionnez le type d\'objet',
      'sos.form.itemTypeCards': 'Cartes nationales',
      'sos.form.itemTypePassport': 'Passeport',
      'sos.form.itemTypeLicense': 'Permis de conduire',
      'sos.form.itemTypeWallet': 'Portefeuille',
      'sos.form.itemTypePhone': 'Téléphone',
      'sos.form.itemTypeKeys': 'Clés',
      'sos.form.itemTypeDocuments': 'Documents',
      'sos.form.itemTypeOther': 'Autres objets',
      'sos.form.itemTypeError': 'Type d\'objet requis',
      'sos.form.lostDateLabel': 'Date de perte *',
      'sos.form.lostDateError': 'Date de perte requise',
      'sos.form.descriptionLabel': 'Description de l\'objet *',
      'sos.form.descriptionPlaceholder': 'Décrivez l\'objet perdu en détail (couleur, marque, contenu, signes distinctifs...)',
      'sos.form.descriptionError': 'Description de l\'objet requise',
      'sos.form.lostLocationLabel': 'Lieu de perte *',
      'sos.form.lostLocationPlaceholder': 'Où avez-vous perdu l\'objet ? (nom du lieu, quartier, rue...)',
      'sos.form.lostLocationError': 'Lieu de perte requis',
      'sos.form.fileUploadLabel': 'Télécharger une photo <span class="optional">(optionnel)</span>',
      'sos.form.fileUploadText': 'Cliquez pour télécharger une photo de l\'objet perdu',
      'sos.form.submit': 'Envoyer le signalement',
      'sos.form.successTitle': 'Signalement envoyé avec succès !',
      'sos.form.successMessage': 'Merci de nous avoir contactés. Nous examinerons votre signalement et le publierons via les canaux de l\'association dans les plus brefs délais. Nous vous contacterons dès que votre objet sera retrouvé.',

      'mag.newsletter.emailPlaceholder': 'Entrez votre adresse e-mail',
      'mag.newsletter.successTitle': 'Abonnement réussi !',
      'mag.newsletter.successMessage': 'Merci de votre abonnement. Vous recevrez les derniers articles et mises à jour directement sur votre e-mail.',
      ...
      'store.searchPlaceholder': 'Rechercher un produit...',
      'store.productsCount': 'Tous les produits ({count})',
      'store.productNotFound': 'Produit introuvable',
      'store.productNotFoundDesc': 'Désolé, le produit demandé est introuvable.',
      'store.orderWhatsApp': 'Bonjour,\n\nJe souhaite commander le produit suivant :\n\n📦 Nom du produit : {name}\n\nMerci.',
      'store.brand': 'Marque',
      'store.condition': 'État',
      'store.conditionNew': 'Neuf',
      'store.conditionUsed': 'Occasion',
      'store.conditionRefurbished': 'Reconditionné',
      'store.sku': 'Référence',
      'store.category': 'Catégorie',
      'store.stock': 'Stock',
      'store.stockInStock': '{count} pièce(s)',
      'store.stockOut': 'Rupture de stock',

      'members.title': 'Membres',
      'members.description': 'Gestion des membres et de leurs données.',
      'members.addMember': 'Ajouter un membre',
      'members.editMember': 'Modifier le membre',
      'members.searchPlaceholder': 'Rechercher par numéro, nom, e-mail ou téléphone...',
      'members.filterAll': 'Tous les statuts',
      'members.statusActive': 'Actif',
      'members.statusInactive': 'Inactif',
      'members.colNumber': 'N° d\'adhésion',
      'members.colName': 'Nom complet',
      'members.colEmail': 'E-mail',
      'members.colPhone': 'Téléphone',
      'members.colAddress': 'Adresse',
      'members.colStatus': 'Statut',
      'members.colDate': 'Date d\'adhésion',
      'members.colActions': 'Actions',
      'members.noMembers': 'Aucun membre.',
      'members.tryAdjust': 'Essayez d\'ajuster la recherche ou le filtre.',
      'members.addFirst': 'Ajoutez le premier membre.',
      'members.docsTitle': 'Documents',
      'members.docsPhoto': 'Photo',
      'members.docsCINFront': 'CIN (recto)',
      'members.docsCINBack': 'CIN (verso)',
      'members.statsTotal': 'Total des membres',
      'members.statsActive': 'Actifs',
      'members.statsInactive': 'Inactifs',
      'members.showing': 'Affichage',
      'members.of': 'sur',
      'members.editDesc': 'Mettez à jour les données du membre.',
      'members.createDesc': 'Remplissez les données pour ajouter un membre.',
      'members.saveSuccess': 'Membre mis à jour avec succès',
      'members.createSuccess': 'Membre ajouté avec succès',
      'members.deleteSuccess': 'Membre supprimé avec succès',
      'members.saveFailed': 'Échec de la mise à jour',
      'members.createFailed': 'Échec de l\'ajout',
      'members.deleteFailed': 'Échec de la suppression',
      'members.loadFailed': 'Échec du chargement',
      'members.statusUpdated': 'Statut mis à jour',
      'members.statusUpdateFailed': 'Échec de la mise à jour du statut',

      'organization.name': 'Association Marocaine des Amateurs de Recherche et d\'Exploration',
      'organization.nameShort': 'Association Marocaine des Amateurs<br>de Recherche et d\'Exploration',
      'organization.description': 'L\'Association Marocaine des Amateurs de Recherche et d\'Exploration est un cadre juridique national qui rassemble les passionnés sous une seule bannière pour préserver le patrimoine national marocain.',
      'organization.copyright': '© 2026 Association Marocaine des Amateurs de Recherche et d\'Exploration. Tous droits réservés.',

      'join.stepper.personalInfo': 'Informations personnelles',
      'join.stepper.emailVerify': 'Vérification e-mail',
      'join.stepper.documents': 'Documents',
      'join.stepper.review': 'Vérification',
      'join.stepper.done': 'Terminé',
      'join.panel.step1of5': 'Étape 1 sur 5',
      'join.panel.step2of5': 'Étape 2 sur 5',
      'join.panel.step3of5': 'Étape 3 sur 5',
      'join.panel.step4of5': 'Étape 4 sur 5',
      'join.panel.personalInfo': 'Informations personnelles',
      'join.panel.personalInfoSub': 'Données de base du membre',
      'join.panel.emailVerify': 'Vérification e-mail',
      'join.panel.emailVerifySub': 'Votre e-mail ne sera pas partagé.',
      'join.panel.documents': 'Télécharger les documents',
      'join.panel.documentsSub': 'Joignez une photo et une copie de votre carte d\'identité',
      'join.panel.review': 'Vérification des informations',
      'join.panel.reviewSub': 'Vérifiez les informations avant de soumettre',
      'join.panel.done': 'Inscription terminée',
      'join.panel.doneSub': 'Votre demande d\'adhésion a été soumise. Nous l\'examinerons et vous contacterons bientôt.',
      'join.form.firstName': 'Prénom *',
      'join.form.lastName': 'Nom *',
      'join.form.birthDate': 'Date de naissance *',
      'join.form.birthPlace': 'Lieu de naissance',
      'join.form.cin': 'N° CIN *',
      'join.form.phone': 'Téléphone *',
      'join.form.email': 'E-mail *',
      'join.form.address': 'Adresse',
      'join.form.city': 'Ville',
      'join.form.profession': 'Profession (optionnel)',
      'join.form.prev': 'Précédent',
      'join.form.next': 'Suivant',
      'join.form.submit': 'Envoyer la demande',
      'join.form.declaration': 'Je certifie l\'exactitude de toutes les informations fournies et j\'assume l\'entière responsabilité légale de toute information inexacte.',
      'join.upload.dragDrop': 'Glissez-déposez l\'image ou cliquez pour sélectionner',
      'join.upload.orClick': 'ou cliquez pour sélectionner',
      'join.upload.maxSize': 'PNG ou JPG — max 5MB',
      'join.email.yourEmail': 'Votre e-mail',
      'join.success.title': 'Merci de votre adhésion !',
      'join.success.memberNumber': 'Votre numéro de membre :',
      'join.success.keepNumber': 'Conservez ce numéro pour référence future.',
      'join.success.saved': 'Vos informations ont été enregistrées.',
      'join.hero.subtitle': 'Remplissez le formulaire pour adhérer à l\'Association Marocaine des Amateurs de Recherche et d\'Exploration',
      'join.hero.title': 'Adhésion <em>en ligne</em>',
      'join.form.birthPlace': 'Lieu de naissance',
      'join.form.checkbox': 'Je certifie l\'exactitude de toutes les informations saisies.',
      'join.otp.instructions': 'Un code de vérification a été envoyé à votre e-mail, veuillez saisir le code.',
      'join.otp.codeLabel': 'Code de vérification',
      'join.otp.sendCode': 'Envoyer le code',
      'join.otp.verify': 'Vérifier le code',
