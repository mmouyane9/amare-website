  ...
  function loadSections(callback) {
    ...
    function tryLoad(retries) {
      ...
      if (!S || !S.getClient) {
        ...
        console.log('[CentralOffice CMS] Supabase client not available after waiting');
      ...
      if (!client) {
        ...
        console.log('[CentralOffice CMS] Supabase client init failed after waiting');
        return callback(null);
      }

      console.log('[CentralOffice CMS] Supabase client ready — fetching page data...');
  ...
  function dispatchSection(section) {
    ...
    switch (type) {
      ...
      case 'custom': {
        ...
        CUSTOM_ORDER++;
        if (CUSTOM_ORDER === 1) { console.log('[CentralOffice CMS] Rendering about'); return injectAbout(data); }
        if (CUSTOM_ORDER === 2) { console.log('[CentralOffice CMS] Rendering tasks'); return injectTasks(data); }
        if (CUSTOM_ORDER === 3) { console.log('[CentralOffice CMS] Rendering process'); return injectProcess(data); }
        if (CUSTOM_ORDER === 4) { console.log('[CentralOffice CMS] Rendering quote'); return injectQuote(data); }
        break;
      }
    }
  }
