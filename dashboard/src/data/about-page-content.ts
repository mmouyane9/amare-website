...
export const ABOUT_PAGE_SECTIONS: PageSection[] = [
  ...
  // =====================================================================
  {
    ...
    data: {
      ...
      description_fr:
        "Découvrez la vision nationale de l'association, sa mission, ses valeurs, son bureau central et sa carte d'expansion dans les différentes régions du Royaume du Maroc.",
      backgroundImage: '',
      buttons: [
  ...
  // =====================================================================
  {
    ...
    data: {
      ...
      description_fr:
        "Nous aspirons à devenir l'association nationale de référence dans l'unification des amateurs de recherche et d'exploration autour d'une vision commune fondée sur la science, la connaissance, la conscience environnementale et l'appartenance nationale. Nous croyons que le citoyen marocain conscient, lorsqu'il reçoit l'opportunité et le savoir, est capable de protéger les richesses naturelles et culturelles de son pays et d'assurer leur durabilité pour les générations futures, à travers une exploration responsable alliant la passion de l'aventure et l'engagement envers l'éthique et les meilleures pratiques.",
      cards: [
        {
          title_ar: 'أجيال واعية',
          title_fr: 'Générations conscientes',
          description_ar:
            'نعمل على تكوين أجيال شابة واعية بأهمية العلم والبحث، قادرة على فهم تراثها الوطني والمساهمة في تطويره وحمايته بمسؤولية.',
          description_fr:
            "Nous œuvrons à former des générations de jeunes conscients de l'importance de la science et de la recherche, capables de comprendre leur patrimoine national et de contribuer à son développement et à sa protection de manière responsable.",
        },
        {
          title_ar: 'تراث مستدام',
          title_fr: 'Patrimoine durable',
          description_ar:
            'نحافظ على التراث الطبيعي والثقافي المغربي ونثمّنه، لضمان انتقاله بكامل قيمته إلى الأجيال القادمة.',
          description_fr:
            "Nous préservons et valorisons le patrimoine naturel et culturel marocain, afin d'assurer sa transmission dans toute sa valeur aux générations futures.",
        },
        {
          title_ar: 'استكشاف مسؤول',
          title_fr: 'Exploration responsable',
          description_ar:
  ...
  // =====================================================================
  {
    ...
    data: {
      ...
      description_fr:
        'Huit valeurs fondamentales qui traduisent nos principes en comportements quotidiens concrets dans tout ce que nous entreprenons.',
      cards: [
  ...
  // =====================================================================
  {
    ...
    data: {
      ...
      description_fr:
        "Le bureau central est l'organe exécutif suprême de l'Association Marocaine des Amateurs de Recherche et d'Exploration. Il est responsable de la gestion des affaires de l'association, de l'élaboration des plans stratégiques, de la coordination des activités nationales entre les branches, du renforcement des partenariats avec les institutions et de la garantie de la réalisation des objectifs et de la mission de l'association dans les différentes régions du Royaume, tout en veillant au respect des valeurs et des principes fondateurs de l'association.",
      ...
      teamDescription_fr:
        "Le bureau central est composé d'une élite de compétences nationales qui veillent à la réalisation des objectifs de l'association et à la concrétisation de sa vision.",
      members: [
        {
          ...
          bio_ar:
            'خبرة واسعة في تدبير الشأن الجمعوي وقيادة الفرق، يشرف على تنفيذ الرؤية الاستراتيجية للجمعية ومتابعة برامجها الوطنية.',
          bio_fr:
            "Vaste expérience en gestion associative et leadership d'équipe. Il supervise la mise en œuvre de la vision stratégique de l'association et le suivi de ses programmes nationaux.",
          color: '#123B78',
          facebook: '#',
          instagram: '#',
          linkedin: '#',
        ...
        },
        {
          ...
          bio_ar:
            'تساهم في تنسيق العمل بين اللجان والمكتب المركزي، وتدبير ملفات التكوين والتأطير لفائدة المنخرطين والمنخرطات.',
          bio_fr:
            "Elle contribue à la coordination du travail entre les commissions et le bureau central, et à la gestion des dossiers de formation et d'encadrement au profit des adhérents.",
          color: '#0F9CD1',
          facebook: '#',
          instagram: '#',
          linkedin: '#',
        ...
        },
        {
          ...
          role_fr: 'Membre du bureau central',
          bio_ar:
            'يساهم في تدبير الميزانية والمحاسبة، ويحرص على الشفافية في تدبير الموارد المالية وفق مقتضيات القانون الأساسي للجمعية.',
          bio_fr:
            "Il contribue à la gestion du budget et de la comptabilité, et veille à la transparence dans la gestion des ressources financières conformément aux dispositions du statut de l'association.",
          color: '#17A44E',
          facebook: '#',
          instagram: '#',
          linkedin: '#',
        ...
        },
        {
          ...
          role_fr: 'Membre du bureau central',
          bio_ar:
            'تساهم في تدبير الجانب الإداري والتوثيقي، وتتبع أشغال المكتب والجمع العام، وتنسيق المراسلات مع الشركاء والمؤسسات.',
          bio_fr:
            "Elle contribue à la gestion administrative et documentaire, au suivi des travaux du bureau et de l'assemblée générale, et à la coordination des correspondances avec les partenaires et les institutions.",
          color: '#DB2777',
          facebook: '#',
          instagram: '#',
          linkedin: '#',
        ...
        },
        {
          ...
          role_fr: 'Membre du bureau central',
          bio_ar:
            'يساهم في إعداد التقارير ومحاضر الاجتماعات، ومواكبة الملفات الإدارية والقانونية المرتبطة بتسيير الجمعية.',
          bio_fr:
            "Il contribue à la préparation des rapports et des procès-verbaux de réunions, et au suivi des dossiers administratifs et juridiques liés à la gestion de l'association.",
          color: '#2563EB',
          facebook: '#',
          instagram: '#',
          linkedin: '#',
  ...
  // =====================================================================
  {
    ...
    data: {
      ...
      mapDescription_fr:
        "Cliquez sur n'importe quelle région pour explorer l'état de l'expansion et le nombre de branches actives ou prévues dans chaque région.",
  ...
  // =====================================================================
  {
    ...
    data: {
      ...
      description_fr:
        "Rejoignez le réseau d'amateurs, de chercheurs et de bénévoles qui partagent avec nous la passion de l'exploration et l'engagement envers la protection du patrimoine marocain, et contribuez avec nous à construire un avenir plus durable.",
