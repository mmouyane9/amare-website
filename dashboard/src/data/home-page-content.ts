    ...
    // =====================================================================
    {
      ...
      data: {
        ...
        features: [
          {
            title: 'برامج تعليمية',
            description: 'دعم مدرسي ومحو أمية لتمكين الأطفال والكبار من فرص تعليمية عادلة.',
          },
          {
            title: 'رعاية صحية',
            description: 'قوافل طبية مجانية دورية لفائدة الأسر في المناطق النائية.',
          },
          {
            title: 'تمكين اقتصادي',
            description: 'تكوين مهني ودعم المشاريع المدرة للدخل للنساء والشباب.',
          },
        ],
        buttons: [
          {
            id: 'btn-about-programs',
            label: 'تعرف على برامجنا',
            url: '#services',
            variant: 'primary',
          },
          {
    ...
    // =====================================================================
    {
      ...
      data: {
        ...
        cards: [
          ...
          {
            heading: 'تمكين اقتصادي',
            description: 'تكوين مهني ودعم للمشاريع المدرة للدخل للنساء والشباب.',
          },
          {
            heading: 'شفافية كاملة',
            description: 'تقارير مالية وميدانية دورية متاحة لجميع الداعمين والشركاء.',
          },
        ],
      },
    },
